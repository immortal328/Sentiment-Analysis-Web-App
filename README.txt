...
2. **Backend Powered by Python and Flask:**
   - **Server:** Flask framework handles the backend processes, ensuring smooth interaction between the frontend and the NLP analysis engine.
   - **NLP Integration:** Utilizes advanced NLP techniques to analyze text data in real-time.

3. **Real-Time Analysis:**
   - **Input Types:** Users can input plain text directly, upload text files, or provide URLs of Flipkart reviews.
   - **Processing:** The app processes the input data to detect and categorize sentiments as positive, negative, or neutral.
...
### Conclusion
The Sentiment Analysis Web App is a powerful tool for anyone needing to understand sentiments in text data. Its combination of an intuitive interface, real-time processing, and detailed graphical insights makes it an essential tool for businesses and individuals alike.

<h3>Steps for using the Web App</h3>
1. Create a virtual env with packages in requirements.txt in the parent folder (this may take some time and internet data to install packages)
2. Activate the env
3. Open terminal and Change the current working directory to parent folder
